...
#pragma region Asset loading
   SDL_Texture* CORE_Graphics::loadSprite(std::string fileName)
   {
      ...
      if (loadedTexture == NULL)
      {
         ...
         CORE_SystemIO::error("Texture: " + fileName + " could not be found");
      }
...
#pragma region Update Methods
	void update()
	{
		...
		{
			//TODO this is idiotic because the drawing queue re-populates for EVERY SINGLE FRAME
			//Only change the queue when something goes away
